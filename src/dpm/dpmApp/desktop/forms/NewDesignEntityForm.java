 ...
 */
public class NewDesignEntityForm extends JFrame implements DpmTerms {
    protected PeerGroup parentPG;
    protected DpmAppTopFrame topFrame;
    protected Prototype initPrototype;
    protected String initIteration = null;
    ...
    public NewDesignEntityForm(PeerGroup parentPG, DpmAppTopFrame topFrame, Prototype initPrototype, String initIteration) {
    ...
    private void setupPoliciesPanel() {
        ...
        if(transRoles != null) {
            for (int i = 0; i < transRoles.size(); i++) {
                ...
                /**@since 24 Nov 2004. Remove ABANDON type policy roles;
                 * otherwise new entity will be immediately abandoned */
                roles.remove(ABANDON);
    ...
    private void setIterationField() {
        if(initIteration == null) {
            iterationField.setText("1");
            return;
        }
        iterationField.setText(initIteration);
    }
    ...
    private void setNameFieldUsingPrototype(Prototype proto) {
        ...
        //NOTE HERE: System.out.println(">>Base name field not set");
        ...
        /**Simplest approach to iteration/proto-copying naming convention:
         * 1. each new entity gets an iteration starting at one;
         * 2. baseNames are copied from prototype;
         * 3. therefore, entities do not necessarily have different names by default */
        
        /**Set proto name field for information purposes */
        String currentIteration = proto.getIteration();
        protoNameField.setText(SPACE + combineNames(protoBaseName, currentIteration));
    }
    ...
    private void setLoopComboModel() {
        ...
        Set netNames = topFrame.getExistingNetNames();
        if(netNames.size() == 0) {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        scrollPaneLinks.setBorder(new javax.swing.border.TitledBorder(null, "Select Links and Entities to be Cloned from Prototype", javax.swing.border.TitledBorder.LEFT, javax.swing.border.TitledBorder.ABOVE_TOP, new java.awt.Font("Arial", 1, 11)));
